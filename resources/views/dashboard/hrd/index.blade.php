            ...
            <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
                <div class="card">
                    <div class="row row-bordered g-0">
                        <div class="col-md-8">
                            <h5 class="card-header pb-3 m-0 me-2">Total Revenue</h5>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="px-xxl-4 gap-xxl-3 gap-lg-1 gap-3 d-flex justify-content-between p-4 px-lg-2">
                                <div class="d-flex">
                                    <div class="me-2">
            ...
            <div class="col-12 col-md-8 col-lg-4 order-3 order-md-2">
                ...
                <div class="row">
                    <div class="col-12 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="gap-3 d-flex flex-column flex-sm-row justify-content-between">
                                    <div class="d-flex flex-row flex-sm-column justify-content-between align-items-start">
                        ...
                        <div class="tab-content p-0">
                            <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
                                <div class="d-flex p-4 pt-3">
                                    ...
                                    <div>
                                        <small class="d-block text-muted">Total Balance</small>
                                ...
                                <div class="gap-2 d-flex justify-content-center pt-4">
                    ...
                    <div class="card-body">
                        <ul class="p-0 m-0">
                            <li class="d-flex pb-1 mb-4">
                                ...
                                <div class="gap-2 d-flex flex-wrap justify-content-between align-items-center w-100">
                                    <div class="me-2">
                                        <small class="d-block text-muted mb-1">Paypal</small>
                            ...
                            <li class="d-flex pb-1 mb-4">
                                ...
                                <div class="gap-2 d-flex flex-wrap justify-content-between align-items-center w-100">
                                    <div class="me-2">
                                        <small class="d-block text-muted mb-1">Wallet</small>
                            ...
                            <li class="d-flex pb-1 mb-4">
                                ...
                                <div class="gap-2 d-flex flex-wrap justify-content-between align-items-center w-100">
                                    <div class="me-2">
                                        <small class="d-block text-muted mb-1">Transfer</small>
                            ...
                            <li class="d-flex pb-1 mb-4">
                                ...
                                <div class="gap-2 d-flex flex-wrap justify-content-between align-items-center w-100">
                                    <div class="me-2">
                                        <small class="d-block text-muted mb-1">Credit Card</small>
                            ...
                            <li class="d-flex">
                                ...
                                <div class="gap-2 d-flex flex-wrap justify-content-between align-items-center w-100">
                                    <div class="me-2">
                                        <small class="d-block text-muted mb-1">Mastercard</small>
                                        <h6 class="mb-0">Ordered Food</h6>
                                    </div>
                                    <div class="user-progress gap-1 d-flex align-items-center">
